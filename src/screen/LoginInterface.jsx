...
function LoginInterface({navigation,value,onChangeText}) {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.MotherView}>
              ...
              <View style={styles.InputView}>
                ...
                <Feather name={secureTextEntry ? 'eye' : 'eye-off'} size={20} color="#000080" />
                </TouchableOpacity>
              </View>
                ...
                <TouchableOpacity onPress={() => navigation.navigate ()}>
                <Text style={{fontFamily:'gilroy-bold',fontSize:15,color:'white',alignSelf:'center', marginTop:50}}>Create an account</Text>
                </TouchableOpacity>
